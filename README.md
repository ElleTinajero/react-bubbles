...
- [ x] Explain what a token is used for.
      ...
      --{ A token is issued by the server, they are strings of cryptic text, which can be stored client-side using local storage. The server can readily tell the client that it issued the token. It can also read the token and make decisions for data transfer based on the client’s permission. Its used for authentication. }

- [ ] What steps can you take in your web apps to keep your data secure?

      --{ Using authentication and allowing a user to login to view personal information relating to them as a user specifically. }
